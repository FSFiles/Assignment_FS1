    ...
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-100 shadow-sm">
      <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <Link to={user ? '/shop' : '/'} className="flex items-center gap-2">
          <div className="w-9 h-9 bg-primary rounded-xl flex items-center justify-center text-xl shadow-md shadow-primary/30">🍽️</div>
          <span className="font-display text-xl font-bold text-gray-900">Fresh<span className="text-primary">Bite</span></span>
        </Link>
